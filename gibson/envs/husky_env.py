...
class HuskyNavigateEnv(CameraRobotEnv):
    ...
    def _rewards(self, action=None, debugmode=False):
        '''Calculating reward and penalties according to the states'''
        a = action
    ...
    def _termination(self, debugmode=False):
        ...
        if done:
            ...
            record = 1
            if record:
                file_path = "/home/deepsrv/PycharmProjects/Gibson_Exercise/gibson/utils/models/success"
                try:
                    os.mkdir(file_path)
                except OSError:
                    pass
                ...
                if self.eps_so_far == 1:
                    with open('/home/deepsrv/PycharmProjects/Gibson_Exercise/gibson/utils/models/success/spl.csv',
