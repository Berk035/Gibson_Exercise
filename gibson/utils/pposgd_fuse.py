...
def traj_segment_generator(pi, env, horizon, stochastic):
    ...
    while True:
        ...
        record_depth=0
        if record_depth:
            path_1 = "/home/deepsrv/PycharmProjects/Gibson_Exercise/gibson/utils/depth_images_iteration"
            try:
                os.mkdir(path_1)
            except OSError:
                pass
...
def learn(env, policy_func, *,
    ...
    while True:
        ...
        record = 1
        if record:
            file_path = "/home/deepsrv/PycharmProjects/Gibson_Exercise/gibson/utils/models/iterations"
            try:
                os.mkdir(file_path)
            except OSError:
                pass
            ...
            if iters_so_far == 1:
                with open('/home/deepsrv/PycharmProjects/Gibson_Exercise/gibson/utils/models/iterations/values.csv',
