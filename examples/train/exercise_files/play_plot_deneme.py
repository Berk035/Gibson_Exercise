...
def main():
    ...
    p = PlayPlot(PlayPlot.callback, horizon_timesteps=300, plot_names=["reward"])
    play(env, zoom=4, fps=60, callback=p.callback)

    #PlayPlot(PlayPlot.callback, horizon_timesteps=300, plot_names=["reward"])
    #p = PlayPlot(callback=PlayPlot.callback, horizon_timesteps=300, plot_names=["reward"])
    #play(env, zoom=4, fps=60, callback=p.callback)
